    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form method="post" action="/admin/articles/<?php echo (int)$article['id']; ?>">
            <div class="mb-4">
                ...
                <input name="title" type="text" value="<?php echo htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8'); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-md" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label class="block text см font-medium text-gray-700 mb-1">Содержимое</label>
                <textarea name="content" rows="8" class="w-full px-4 py-2 border border-gray-300 rounded-md" required><?php echo htmlspecialchars($article['content'], ENT_QUOTES, 'UTF-8'); ?></textarea>
            </div>
            <div class="mb-4">
