    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="/admin/categories/create"
                class="bg-sky-600 text-white px-3 py-1 rounded-md hover:bg-sky-700 text-sm">Добавить</a>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Название
                        </th>
        ...
        <?php else: ?>
            <p class="text-gray-600">Категорий пока нет.</p>
        <?php endif; ?>
        </table>
    </div>
</div>